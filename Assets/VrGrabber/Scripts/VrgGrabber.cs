...
namespace VrGrabber
{
    ...
    public class VrgGrabber : MonoBehaviour
    {
        ...
        void FixedUpdateGrabbingObjectBySingleHand()
        {
            ...
            var dist = Mathf.Clamp(grabInfo_.distance + grabInfo_.stickMove, minGrabDistance, maxGrabDistance);
        ...
        void FixedUpdateGrabbingObjectTransform(Vector3 pos, Quaternion rot, Vector3 scale)
        {
            ...
            var a = ((Mathf.Clamp(grabInfo_.distance, minGrabSmoothDist, maxGrabSmoothDist) - minGrabSmoothDist) / (maxGrabSmoothDist - minGrabSmoothDist)) +minGrabDistance;
